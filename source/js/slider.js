...
if (document.documentElement.clientWidth < 768) {
  ...
  const SELECTOR_ITEM = '.chief-slider__item';
  const SELECTOR_ITEMS = '.chief-slider__items';
  const SELECTOR_WRAPPER = '.chief-slider__wrapper';
  const SELECTOR_PREV = '.chief-slider__control[data-slide="prev"]';
  const SELECTOR_NEXT = '.chief-slider__control[data-slide="next"]';
  const SELECTOR_INDICATOR = '.chief-slider__indicators>li';

  const SLIDER_TRANSITION_OFF = 'chief-slider_disable-transition';
  const CLASS_CONTROL = 'chief-slider__control';
  const CLASS_CONTROL_HIDE = 'chief-slider__control_hide';
  const CLASS_ITEM_ACTIVE = 'chief-slider__item_active';
  const CLASS_INDICATOR_ACTIVE = 'chief-active';
